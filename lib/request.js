...
const GETTERS = 
{
    query : function()
    {
        return cacheValue( this, 'query', this.url.includes('?') ? Querystring.parse( this.url.replace( /^.*?\?/, '' ), this.__options?.query?.types ) : {});
    },
    cookies : function()
    {
...
module.exports = function Request( request, options )
{
    ...
    Object.defineProperty( request, '__options', { value: options });
